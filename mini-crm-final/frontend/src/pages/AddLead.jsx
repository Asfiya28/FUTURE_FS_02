  ...
  return (
    <div className="animate-fade-in" style={{ maxWidth: '720px', margin: '0 auto' }}>
      ...
      <div style={{
        ...
        <h2 style={{ fontSize: '1.4rem', fontWeight: 700, color: '#1e293b', marginBottom: '8px' }}>Add New Lead</h2>
        <p style={{ color: '#64748b', marginBottom: '28px', fontSize: '0.9rem' }}>Enter the lead details below.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <textarea
              ...
              rows="4" placeholder="Any additional notes about this lead..."
